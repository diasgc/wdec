...
document.getElementById("enc").onclick = function(){
    var myString=inputfield.value;
    var encoded=encode_ascii85(myString);
    document.getElementById("output-field").value = encoded;
    qrc.makeCode(encoded); 
};
inputfield.oninput = function(){
    let l = inputfield.value.length;
    document.getElementById("in_chars").innerHTML = l + " chars";
}

document.getElementById("dec").onclick = function(){
    myString=document.getElementById("output-field").value;
    var decoded=decode_ascii85(myString);
    console.log("decoding ",myString," to ",decoded);
    document.getElementById("input-field").value = decoded;
}